...
MONITOR_LABEL="com.rymag.ticket-monitor"
GUARDIAN_LABEL="com.rymag.ticket-monitor.guardian"
RELOADER_LABEL="com.rymag.ticket-monitor.reloader"
BROWSER_HOST_LABEL="com.rymag.ticket-monitor.browser-host"
GUI_DOMAIN="gui/$(id -u)"
